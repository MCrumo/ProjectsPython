...
#====================================================================#
#------------------------GLOBAL VARIABLES----------------------------#
fileName = "connLog.txt"
path = ""           # "/home/miquel/Desktop/"
retryInterval = 1   # Retry every x seg if there is connection
checkInterval = 5   # Check every x seg if still connected
ipPing = "8.8.8.8"  # IP 8.8.8.8 -> Google
portPing = 53       # Port 53 TCP/UDP
#====================================================================#
